...
import LinkifyText from '@/shared/components/ui/LinkifyText';
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 p-5 border-b border-slate-200 dark:border-white/[0.08]">
          <div className="space-y-2 min-w-0">
            ...
            <h2 id="task-detail-title" className="text-lg font-bold tracking-tight text-slate-900 dark:text-white pr-2 break-all">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <section aria-labelledby="task-info-heading">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-white/[0.08] bg-slate-50/50 dark:bg-white/[0.02] p-4 space-y-3">
              <p className="text-[13px] text-slate-600 dark:text-white/70 leading-relaxed break-all">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] font-medium text-slate-800 dark:text-white/90 break-all">
                      <LinkifyText text={task.assignedTo} />
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2.5">
              ...
              {activityTimeline.map((item, index) => (
                <div key={index} className="relative flex gap-3">
                  ...
                  <div className="flex-1 min-w-0 -mt-0.5">
                    ...
                    <p className="text-[12px] text-slate-500 dark:text-white/45 leading-relaxed break-all">{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
