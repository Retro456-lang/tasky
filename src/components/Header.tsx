  ...
  return (
    <header className="h-14 border-b border-slate-200 dark:border-white/[0.06] bg-white/80 dark:bg-[#0f1117]/80 backdrop-blur-xl sticky top-0 z-40 flex items-center justify-between px-4 lg:px-6">
      ...
      <div className="flex items-center gap-1">
        ...
        {/* User avatar */}
        <div className="flex items-center gap-2.5 pl-2 ml-1 border-l border-slate-200 dark:border-white/[0.06]">
          <div className="text-right hidden sm:block">
            <p className="text-xs font-medium text-slate-700 dark:text-white/80">Rahul Dev</p>
            <p className="text-[10px] text-slate-400 dark:text-white/40 leading-tight">Developer</p>
          </div>
          <div className="w-7 h-7 rounded-md bg-gradient-to-br from-indigo-500/20 to-violet-500/20 dark:from-indigo-500/20 dark:to-violet-500/20 border border-slate-200 dark:border-white/[0.08] overflow-hidden flex items-center justify-center text-[10px] font-semibold text-indigo-600 dark:text-indigo-300">
            RD
          </div>
        </div>
      </div>
