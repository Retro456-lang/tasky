...
import StatusBadge from '@/features/tasks/components/badges/StatusBadge';
import PriorityBadge from '@/features/tasks/components/badges/PriorityBadge';
          ...
          <thead>
            <tr className="border-b border-slate-200 dark:border-white/[0.08] bg-slate-50 dark:bg-white/[0.03]">
              ...
              >
                <div className="flex items-center gap-1">
                  Assigned To
                  <SortIcon field="assignedTo" sortField={sortField} sortDirection={sortDirection} />
                </div>
              </th>
              <th
              ...
              >
                <td className="p-3 pl-4">
                  <div className="space-y-0.5 min-w-0">
                    ...
                    <p className="text-[11px] text-slate-400 dark:text-white/35 truncate max-w-[280px]">
